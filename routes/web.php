...
Route::group(['middleware' => ['checkout']], function(){
	...
	Route::get('checkout/shipping_info','CheckoutController@getShippingInfo')->name('checkout.get_shipping_info');
...
Route::get('/nic-callback', 'CheckoutController@nicCallback')->name('nic_callback');
...
Route::group(['middleware' => ['user', 'verified']], function(){
	...
	Route::get('/order-status', 'HomeController@orderStatus')->name('order.status');
