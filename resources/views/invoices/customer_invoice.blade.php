	...
	<div>
		...
		<div style="padding: 1.5rem;padding-bottom: 0">
			<table>
				...
				<tr><td class="strong">{{ (isset($shipping_address->name))?$shipping_address->name:'Empty' }}</td></tr>
				<tr><td class="gry-color small">{{ $shipping_address->address }}, {{ $shipping_address->city }}, {{ $shipping_address->country }}</td></tr>
				<tr><td class="gry-color small">Email: {{ (isset($shipping_address->name))?$shipping_address->email:'Email' }}</td></tr>
